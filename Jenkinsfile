pipeline {
    ...
    environment {
        ...
        TRIVY_HOME = '/usr/bin'
        REPO_URL = 'https://github.com/kaungmyat-hub/youtube-clone-CICD.git' 
        REPO_BRANCH = 'main'
        DOCKER_IMAGE_NAME = '/kaungmyat92/youtube-clone'
        SONAR_PROJECT_NAME = 'Youtube-CI'
        SONAR_PROJECT_KEY = 'Youtube-CI'
    ...
    stages {
        ...
        stage('Install Dependencies') {
            steps {
                script {
                    def nodeHome = tool name: 'nodejs16', type: 'nodejs'
        ...
        //                 sh "sed -i.bak 's|image: kaungmyat-hub/youtube-clone:.*|image: kaungmyat-hub/youtube-clone:${env.IMAGE_TAG}|' deployment.yml && rm deployment.yml.bak"
